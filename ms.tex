...
See paper I. VERY SHORT summary here

\section{Results}
Plots of SFR, gas mass evolution, phase evolution, mass loading factors. Figure out a reasonable selection of panels to show that demonstrate the characteristic differences in outflow properties. Particularly one early on during first "break-out" of SNe and one at late time. Plot metal mass fraction retention.

\begin{figure*}
\centering
\includegraphics[width=0.32\linewidth]{sfr}
\includegraphics[width=0.32\linewidth]{mass}
