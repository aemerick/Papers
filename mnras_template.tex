...
\begin{figure*}
\includegraphics[width = 0.32\linewidth]{fgas_mstar_binned_IQR_logged.png}\\
\includegraphics[width = 0.32\linewidth]{MHI_Mstar_binned_IQR.png}
\includegraphics[width = 0.32\linewidth]{gasless_fraction_mstar.png}
