...
\caption{Edge-on slices of each simulation showing gas number density (left), temperature (middle), and hydrogen ionization fraction (right) 17~Myr after the formation of the first star in each run. Each panel is 4 kpc x 4 kpc. The full movie of this evolution is included for further clarification of the comparison between this figure and Fig.~\ref{fig:panel2}.}
\label{fig:panel1}
\end{figure*}
