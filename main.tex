...
\caption{The separation (in dex) of each star's oxygen fraction from the median value of the gas phase oxygen mass fraction PDF for the CNM at within 1~Myr (our time resolution) of each star's formation time. The median deviation is given in the plot for stars formed after the initial enrichment period, or 100~Myr.}
\label{fig:stars}
\end{figure}
