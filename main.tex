...
The galaxy initially consists of a smooth, exponential gas disk in hydrostatic equillibrium with a static, background dark matter potential. The gas profile follows \citet{Tonnesen2009} and \citet{Salem2015}, with
\begin{equation}
...
In both panels, we also include recent observational constraints from these relationships. We include the KS fits from \citet{Shi2011} with 1$\sigma$ errors (black), the fits 
%mm
   and errors 
from \citet{Roychowdhury2014} (blue), and the individual points 
%mm
   (black squares) 
from the recent SHIELD sample \citep{Teich2016}; we include only the fit and 1$\sigma$ errors from \citep{Shi2011} for the ESL (black), which have been shown to match well for dwarf galaxies at these surface densities \citep{Roychowdhury2017}. In both relationships our simulations fit well around the median observed fit, spanning the 1 $\sigma$ variations about the mean. 
