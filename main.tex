...
\begin{enumerate}
\item Multi-channel feedback is effective in regulating star formation to a rate consistent with the Kennicutt-Schmidt relationship and the extended Schmidt law in observed galaxies. (See Figures~\ref{fig:sfr_mass_evolution} and \ref{fig:KS}).
...
\textbf{As discussed in Section~\ref{sec:molecular gas content}, H$_2$ formation is dominated by the gas-phase H$^{-}$ channel in our simulations. Accounting for the photodetachment of H$_{-}$ from the stellar radiation field, which can dominate over the UVB, is potentially important for correctly modeling H$_2$ formation in low metallicity gas\citep{WolcottHaiman2012}. In addition, radiation from lower mass stars may be important in the is regime as the H$^{-}$ photodetachment threshold is low, or 0.76~eV. }
