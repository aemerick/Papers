...
\item A thin, yet resolved, gas scale height ($\sim$~50~pc) beyond our stellar radius, with larger scale heights ($\sim 100 - 200$~pc) driven by feedback interior to the stellar radius. This is comparable to the resolution limit of the diffuse \ion{H}{1} in observed, gaseous UFDs. See Figure~\ref{fig:scale_height}.
