...
\begin{figure*}
\centering
\includegraphics[width=0.99\linewidth]{species_bar}\\
\includegraphics[width=0.99\linewidth]{species_bar_ISM}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\linewidth]{species_bar_sources}\\
...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{SE_density}\\
\includegraphics[width=0.95\linewidth]{SE_z}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\linewidth]{DD0390_element_by_element}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\linewidth]{O_Ba_distribution_evolution}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\linewidth]{Half_AGB_Fraction_elements_s0}
...
\begin{figure}
\centering
\includegraphics[width=0.95\linewidth]{stellar_CNM_distance}
...
\begin{figure}
\centering
\includegraphics[width=0.475\linewidth]{density_PDF}
\includegraphics[width=0.475\linewidth]{density_PDF_volume_weighted}\caption{The mass-weighted (left) and volume weighted (right) density PDFs of our dwarf galaxy at an arbitrarily chosen time of 250~Myr. The total distribution is given in black, sub-divided by the contributions of the individual phases in the ISM.}
...
\begin{figure*}
\centering
\includegraphics[width=0.95\linewidth]{O_Ba_resolution_study}
